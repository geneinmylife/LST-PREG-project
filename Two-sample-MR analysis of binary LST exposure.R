######### Two-sample-MR analysis of binary LST exposure
...
exposure_dat <- read_exposure_data(
  filename = as.character("transform_output_LST_0_2_e6_cojo.txt"),
  sep = "\t",
  snp_col = "SNP",
  beta_col = "b",
  se_col = "se",
...
exposure_dat$exposure <- "LST_Female_0_2_cojo_adjusted_beta"

#exposure2-LST_0_6
exposure_dat <- read_exposure_data(
  filename = as.character("transform_output_LST_0_6_e6_cojo.txt"),
  sep = "\t",
  snp_col = "SNP",
  beta_col = "b",
  se_col = "se",
...
exposure_dat$exposure <- "LST_Female_0_6_cojo_adjusted_beta"
